...
public class restpasseService {
    ...
    private static final String EMAIL_USERNAME = "chaibiray@gmail.com";
    private static final String EMAIL_PASSWORD = "ijtlhnnywlxbarcj";
    ...
    private static final String APP_NAME = "JavaFX Health App";
